package com.ppb.salsa.database.dao;
...
public interface DatabaseDao {
    ...
    @Query("SELECT * FROM tbl_data where uid != 1")
    ...
    //untuk update data
    @Query("UPDATE tbl_data SET nama_menu= :nama_menu, jml_items= :jml_items, harga= :harga WHERE uid = :uid")
